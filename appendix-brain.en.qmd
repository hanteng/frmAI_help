...
Readers who want a more granular, explicitly multi-timescale cognitive architecture — including a fourth, collective/institutional tier — may find Taniguchi et al.'s System 0/1/2/3 framework a useful complement [@Taniguchi2025System]. It is compatible in spirit with this book's approach but is not this taxonomy's source: its System 0 and System 2 correspond roughly to this book's Reactive and Reflective-Symbolic tiers, but its System 1 (individual fast cognition) does not cover the relational/social ground that this book's Emotive-Relational tier is built to cover — that tier is drawn from social-brain research instead. See [@sec-tri-aspect-cognitive] "A Note on Granularity" below for more.

:::

Dual-process research robustly supports a distinction between fast, automatic processing and slower, reflective processing, but also warns against reifying this into only two neatly localized brain systems [@Evans2008Dual-processing; @Evans2013Dual-Process; @Frankish2010Dual-Process]. On its own, however, dual-process theory offers no natural home for social and emotional processing. 

This is where this book's synthesis does its real work: the middle tier — the 🐘💞 **Emotive-Relational Mind** — is proposed here to fill that gap, drawing on social-cognition research that supports a hierarchical, multilevel structure of partially separable cognitive and affective processes rather than a single faculty such as empathy or theory of mind [@Schurz2020Toward; @Happé2017The]. The resulting reactive / emotive-relational / reflective-symbolic triad is therefore a genuine three-way synthesis of two source theories, not a restatement of either one.
