...
- 🔴 **Core Circle**: the AI knowledge points summarized in this book, cross-referenced in **[🔖Appendix 🌌 Mindmap](appendix-evolving_mindmap.qmd)** (e.g., neural networks, reinforcement learning, knowledge graphs).    
...
- 💥 **[AI Alignment Collapse Hypothesis](appendix-glossary.qmd#sec-ai-alignment-collapse)**: if an AI's world model fails to embed human values, will alignment failure follow?    
...
- 🚰 **[AI Utilities Hypothesis](appendix-glossary.qmd#sec-ai-utilities-hypothesis)**: will AI become a basic utility of daily life, like water or electricity?
