...
A brief cross-appendix note: this same grounding work can also be tested arena by arena — subjective, objective, intersubjective, interobjective — using the **AQAL Four Quadrants** framework developed fully in 💪[Action](appendix-action.en.qmd#sec-verbs-in-world); here we invoke it only to note that grounding is not a single test but four simultaneous ones, and that fuller treatment belongs to that appendix, not this one.
