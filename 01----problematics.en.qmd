...
從甲骨到大語言模型，人類不斷尋求 [❝腦補❞](appendix-glossary.qmd#def-mental-fill-in) 來擴展心智、解決問題。  
...
- 🪁 **啟發式**：指『**經驗法則**』或『**簡化策略**』，這是一種可快速有效、基於經驗、雖易產生偏差但實用的應對方法。例如，像 [完形心理](01-05-Gestalt_Psychology.qmd) 的快速感知❝腦補❞潛在威脅，或在陌生環境要「多聽少說」，這種可繞過**複雜分析**的「認知捷徑」是帶有**特定方向**的考量，如求生存。
...
* ﹝未完稿﹞🎭🎲 [模仿遊戲 🆚 語言賽局](01v07-Imitation_Game_vs_Language_Games.qmd) 
* ﹝未完稿﹞🔤🖼️ [框架問題 🆚 符碼紮根問題](01v03-Frame_Problem_vs_Symbol_Grounding_Problem.qmd)
...
- 💥 **[AI 對齊崩潰假說](appendix-glossary.qmd#sec-ai-alignment-collapse)** （AI Alignment Collapse Hypothesis）：隨著 AI 能力提升，若無法持續確保其行為與人類價值對齊，將導致追求衝突目標、產生有害行為，最終引發社會決策、經濟與安全體系的**系統性失序與混亂**。
...
- 🚰 **[AI 公用事業假說](appendix-glossary.qmd#sec-ai-utilities-hypothesis)**（AI Utilities Hypothesis）：主張 AI 將如同電力或網路一樣，成為**普及、隱形、無所不在的社會基礎設施**，並由政府、企業與社群共同監管，以確保公平取用與安全性。
