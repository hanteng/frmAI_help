...
**框架問題**可以粗分為經典與現代兩種觀點，前者點出形式邏輯的技術瓶頸，後者則捕捉智能系統或智能生體面對的認知與情境挑戰（有限認知資源面對無限可能）。
...
簡言之，框架問題經典觀點表明，在某些「狹窄」的 AI 領域中，框架問題是可控且可被克服的，有效地用符號邏輯定義「不變」及o計算例外，系統能框架現實並做出適切反應。
