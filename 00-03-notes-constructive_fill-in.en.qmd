...
- Chinese version: 9070 characters
- English version: 14792 characters
:::
...
Following on from the ❝[Introduction](00-02-notes-mental_fill-in.en.qmd)❞, this ❝Note❞ chapter invites readers to reflect together: starting from 2025, how might we foresee our 2035 selves?
...
準備好了嗎？在深入探討「思維定勢」與「框智力」之前，不妨先動手做一個小小的科技預見練習——見 🔖附錄A. 💪 [行動](appendix-action.en.qmd#sec-ai-cost-forecasting-worksheet) 中的《AI 代價與未來生活預見練習》，親手估算一次 AI 問答的能耗代價，並想像自己在 2025、2030、2035 三個時間點的生活樣貌。
...
完成後，你會更能體會「被補全」與「自補全」之間的抉擇。詳見 🔖附錄A. 💪 [行動](appendix-action.en.qmd#sec-ai-cost-forecasting-worksheet)。
...
❝[腦補](appendix-glossary.en.qmd#def-mental-fill-in)❞ 與 🙶補全🙷 之間，其實還有「**思維定勢**」或譯「**心理定勢**」（mental set）的概念。它指人類在解題或思考時，習慣使用「套路」（即過去成功的方法）來處理新問題。這能快速套用經驗、節省思考成本，但也容易導致「認知僵化」。這種取捨，正與「快思慢想」[@sec-dual-process-theory] 的二元模式相呼應。

的確 ❝[腦補](appendix-glossary.en.qmd#def-mental-fill-in)❞ 本能是勾勒出經驗與想像「事實」，驅使我們「行動」的「**知行捷徑**」，這包括演化出來生下來就可能有的 [完形心理](01-05-Gestalt_Psychology.en.qmd)，也包括後來環境及社會習慣學得的「套路」，或較符合教育或心理學的說法，「經驗法則」（heuristics）。
...
所以這本工具書的目標就能比較清楚且謙和的說明：介紹 AI 如何建構出不同的❝[腦補](appendix-glossary.en.qmd#def-mental-fill-in)❞套路，以及說明幾種較具科學或實踐意義的「經驗法則」，在這一點上可能和占星、魔術、厚黑、把妹等等書籍差不多。差比較多的可能是說破這些「套路」的同時，突出其本質上要應對的 [AI 問題意識](01----problematics.en.qmd)，這樣子就把改變及創新的責任又交還給讀者。
...
如此，讀者即可較容易理解 [框架問題](01-04-Frame_Problem.en.qmd) 為何是 AI 問題意識的核心「套路」問題，而 [符碼紮根問題](01-03-Symbol_Grounding_Problem.en.qmd) 為何可以看成某一「套路」在某一場景的有效性檢驗問題。
...
它呼應了[第壹篇](01----problematics.en.qmd) [@#nte-problematics]中的核心議題：
...
**擇**其所需、**取**其所長，既能渡己，亦能渡人。更多詳見 🔖附錄A. 💪[行動](appendix-action.en.qmd) [@imp-aqal-4-quadrants]。  
...
更多詳見 🔖附錄A. 💪[行動](appendix-action.en.qmd) [@imp-aqal-4-quadrants]。  
...
為了解決複雜組織的動態適應問題，管理科學家 Stafford Beer 發表了其經典的三部曲著作 [@beer_1972-BrainFirmDevelopment-BrainFirmDevelopment; @beer_1979-HeartEnterprise-HeartEnterprise; @beer_1985_2007-DiagnosingSystemOrganizations]，將模控學原理完全落實到組織設計中，提出了「可行系統模型」（Viable System Model, VSM）。
...
* 🏙 **動手練習**：還沒做過本章開頭提到的《AI 代價與未來生活預見練習》嗎？見 🔖附錄A. 💪 [行動](appendix-action.en.qmd#sec-ai-cost-forecasting-worksheet)。
* 🔖 **AI 分類對照**：想知道「AI 導向」與「流派主義」這兩套分類法如何銜接 [第壹篇 ㉄](01----problematics.en.qmd) AI 問題意識嗎？見 🔖附錄🌌 [心智圖](appendix-evolving_mindmap.en.qmd#sec-ai-taxonomy-comparison)。
<!--* 🙈 **創作示範**：想看看「補全」落實在文學創作上的示範嗎？見 🔖 [大聖歸來：仿葉慈新詩](appendix-poem.en.qmd)，一首以《西遊記》意象改寫葉慈《二度降臨》的中文新詩。-->
