...
### AI Alignment Collapse Hypothesis {#sec-ai-alignment-collapse}
...
### AI Utilities Hypothesis {#sec-ai-utilities-hypothesis}
...
> See also: [`game theory`](#sec-game-theory)
...
::: {.callout-important #imp-this-book-mental-fill-in title="📖 How This Book Uses the Term (Not the Common-Usage Definition)"}
...
> See also: [`Scaffolding`](#scaffolding); [`Cognitive Scaffolding`](#sec-cognitive-scaffolding); [`Constructive Fill‑in`](#sec-constructive-fill-in)  
> Read: 💬 Introduction ~ [`❝Mental Fill-ins❞: Cognitive Shortcuts`](00-02-notes-mental_fill-in.qmd)
...
> Read: [▜Appendix B ~ 🧠Brain: «Observe» Tao-Intelligence Practice](appendix-brain.qmd)
...
### 🌐 Ontology {#sec-glossary-ontology}
<sup> ⁃ 本體論</sup>
...
### 🧠 Ontology Learning {#sec-glossary-ontology-learning}
<sup> ⁃ 本體論學習</sup>
