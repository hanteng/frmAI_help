...
`完形心理`（又稱`格式塔心理學` **Gestalt Psychology** ）探討人類如何組織、感知與理解世界的心理學流派。其核心觀點之一常被通俗轉述為「整體大於部分之和」（The whole is greater than the sum of its parts），但這其實是對 Kurt Koffka 原始論點的常見誤譯／誤傳。Koffka 原本要強調的其實更接近「整體**不同於**（或**異於**）部分之和」（the whole is *other than* the sum of its parts）——重點不在於整體的「量」比較多，而在於整體具有一種部分相加所沒有的、湧現而出的結構。人類的大腦會自動將零散的資訊組織成有意義的整體結構，而非簡單地逐一處理細節。
...
> **編輯說明：** 下表為本條目作者的原創詮釋，並非格式塔心理學或具身認知文獻中既有的對應關係。格式塔心理學與具身認知確實是兩個彼此相關的學術傳統，但下表逐項對應的具體內容屬於作者為了教學說明所搭建的詮釋橋樑，並非可直接引用的既定研究成果，請讀者以此理解，而非視為學界定論。

| 完形心理學原則             | 作者提出的具身認知對應（非既有文獻定論）                  |
| ------------------- | -------------------------- |
...
儘管這幅圖指的是動物猴子，但可以銜接人類睿智教訓的抽象符號語意，**「人」應該不見、不聞、不言**。不過，這個圖像與教訓之間的歷史淵源其實仍有爭議，並非一條清楚可考的傳承脈絡：「三猴」的圖像本身源自日本（最著名的是日光東照宮十七世紀的雕刻），它與更早的中國文獻之間的關聯，較屬於學者的推測重建，而非有明確文獻記載的直接傳承。常被引用的一個候選源頭是《論語》的禮儀：「非禮勿視、非禮勿聽、非禮勿言、非禮勿動」。在西方，這句話也常和甘地連結在一起——但這並非因為這是甘地自創的教誨，而是因為甘地生前所保有的少數個人物品中，就有一尊三猴的小雕像，這也連帶讓這句話與甘地的克己倫理產生了通俗上的聯想。
...
- [x] 邏輯流程
- [x] 內部連結－所有相關條目
- [x] 標註作者原創詮釋（完形原則與具身認知對應表）為個人綜合觀點，非既有文獻定論
- [x] 修正常見誤傳的 Koffka 名句（「大於」→「不同於／異於」）
- [x] 修正甘地相關敘述（其關聯來自其保有的雕像，而非其原創教誨）
- [x] 說明三猴圖像與《論語》之間的傳承關係屬學界推測，並非確鑿史實
- [ ] 外部連結－所有相關條目（Koffka、Lakoff & Johnson、三猴歷史等引用仍待補齊）