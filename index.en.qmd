...
## 🧭 «The Appendix Triad»: An Agent-Neutral Epistemic and Action Framework

This book utilizes three mutually echoing appendices—💪 [Action](appendix-action.en.qmd), 🧠 [Mind](appendix-brain.en.qmd), and 🪜 [Capacity](appendix-cognitive_capacity.en.qmd)—to unpack "what to know" from "how to decide and act", before recombining them for practical execution. This taxonomy deliberately refrains from presupposing priority between "humans" or "machines": each appendix outlines parallel versions for both human and AI agents, allowing readers to choose any entry point.

* First ask "**What is worth knowing?**"—See 🧠 *Mind*: ⟨The Tripartite Mind⟩ and the Concentric Circles of Nouns.
* Next ask "**How to act once known?**"—See 💪 *Action*: Verb Syntax and the AQAL Quadrants.
* Finally ask "**How to converge options into choices?**"—See 🪜 *Capacity*: The Double Diamond Model and Constructive Scaffolding.
...
In academic terms, «The Appendix Triad» roughly corresponds to **Ontology**, **Epistemology**, and **Methodology**, deliberately engineered to be **substrate-neutral**. The exact same set of categories applies simultaneously to human and machine (AI) agents, rather than centering on human cognition and extrapolating to machines secondarily.

| Academic Dimension | Corresponding Appendix | Core Content |
| :--- | :--- | :--- |
| **Ontology** (What exists) | 🧠 *Mind* | Concentric Circles of Nouns (Core / Middle / Outer); ⟨Tripartite Mind⟩ (Reactive / Affective-Relational / Reflective-Symbolic) |
| **Epistemology** (How we know & categorize) | 🧠 *Mind* (Primary), 💪 *Action* (Secondary) | Human vs. Machine Learning contrasts (Behaviorism / Situatedness / Connectionism); AQAL Quadrant cognitive pathways (Subjective / Objective / Intersubjective / Interobjective) |
