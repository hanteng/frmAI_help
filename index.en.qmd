...
From **oracle bones** to **Large Language Models (LLMs)**, humanity has continuously sought ❝[mental fill-in](appendix-glossary.qmd#def-mental-fill-in)❞ to expand consciousness and solve problems. 
...
This handbook is rooted in the foundational **problematics** (referring to foundational questions, frameworks, methods, and systemic awareness collectively established through a field's development; see [Part 1 ㉄](01----problematics.qmd)) of artificial intelligence. Through rigorous **fact-checking** and **logical tracing**, it guides readers in constructing their own personalized **[🪜 Knowledge-Action Scaffolding](00-03-notes-constructive_fill-in.qmd)**.
...
Anchored in core **problematics** at its origin (see [Part 1 ㉄](01----problematics.qmd)) and aiming toward innovative **AI Engineering** methodologies at its destination (see Part 10 🌉), this handbook traverses the following chapters:
...
* Selecting knowledge and case studies focused on **embodiment**, **game theory**, and future foresight—ensuring systematic understanding of historical evolution and inspiring innovative future insights:
    * "Game-Theoretic AI" (see [Part 7 🏆](07----game_ai.qmd)),
    * "Embodied AI" (see [Part 8 🦾](08----embodied_ai.qmd)), and
    * "AI Mathematics" (see [Part 9 📐](09----ai_math.qmd)).
* Systematically introducing **schools** and **paradigms** to integrate classical foundations with modern practices:
    * [Part 2 🎏🏮](02----schools_paradigms.qmd) Schools & Paradigms
        * **2.1** 🎏🏮🏛️ [Symbolic AI / Symbolism](02-01-symbolic_ai.qmd)
        * **2.5** 🏮🧬 [Connectionism](02-05-connectionism.qmd)
        * **2.6** 🏮💪 [Behaviorism](02-06-behaviorism.qmd)
    * [Part 3 🏛️](03----symbolic_ai.qmd) Symbolic AI
    * [Part 4 🌀](04----statistical_ai.qmd) Statistical AI
* Highlighting systemic innovation and analytical depth by synthesizing the 5 "AI Orientations" (see [Part 5 ☸](05----ai_orientations.qmd)) and 6 points of "Analytics & Decisions" (see [Part 6 ❖](06----analytics_decisions.qmd)).

The inclusion of Game‑oriented AI also echoes the “Dao / Artifice” theme because current LLM‑agent research uses simulated social interaction, cooperation, planning, and feedback as testbeds for strategic behavior, but finds persistent instability from prompt sensitivity, hallucinations, and control problems [@Lu2024LLMs; @russell2021]. While these studies show why games should be treated as **AGI testbeds** rather than proof of general intelligence, this book takes a step further by asking readers to be aware of the manipulation and power dynamics of AI design and use.

***

This chapter structure not only outlines a comprehensive framework but also encourages readers to build their own **[🪜 Knowledge-Action Scaffolding](00-03-notes-constructive_fill-in.qmd)**, systematically generating essential **Verb-Noun** combinations via the author's novel taxonomy [Note @nte-ai-scaffolding].

## 🖼️ Scope of This Book

From the earliest debates on the **symbol grounding problem**—how symbols gain meaning beyond human interpretation [@Harnad1990The]—to the enduring **frame problem** of predicting what changes and what remains stable in a dynamic world [@Shoham1987What; @Schubert1990Monotonic], the foundations of AI have always been tied to both practical considerations and deep philosophical questions.
...
Contemporary surveys now emphasize that neither symbolic reasoning nor neural networks alone are sufficient; instead, hybrid approaches are emerging as the “third generation” of AI [@Zhu2023Toward; @Ali2025Agentic; @Ye2025From; @russell2021]. This shift is visible in the rise of **embodied AI**, where agents must perceive, reason, and act in real environments [@Feng2025Embodied; @2024A].
...
Supplementing and triangulating all the content chapters, this book presents three appendices that echo one another: [“💪Action”](appendix-action.qmd), [“🧠Brain”](appendix-brain.qmd), and [“🪜Capacity”](appendix-cognitive_capacity.qmd). 

Why do we need these? Recent conceptual work explicitly argues that effective human–AI collaboration depends on three linked questions: the ontological role of AI, how humans and AI jointly construct knowledge, and how systems practically enable that interaction [@Apriyani2025A]. This maps closely to the **Action–Brain–Capacity triad**, and further supports treating both AI and human agency as a continuum rather than as separate categorie.
...
* [Part 2 🎏🏮](02----schools_paradigms.qmd) Schools & Paradigms
* [Part 5 ☸](05----ai_orientations.qmd) Distinguishing the 5 AI Orientations [Tip @tip-ai-orientations]

::: {#tip-book-zen .callout-tip title="Zen Poem: 🎲 The Game vs. 🏁 The Framing"}

This book is titled *Framing Intelligence*, also subtitled *The Dao & Artifice of Intelligence*. Beyond emphasizing the core AI problem—[The Frame Problem](01-04-Frame_Problem.qmd)—it attempts a touch of Zen philosophy to illuminate the game-theoretic dilemma of contemporary AI:
...
3. **Reinterpreting Classical Concepts**: Connecting classic knowledge points with modern topics like `Large Language Models (LLMs)` under the new idiom "investigating things to extend intelligence", constructing a self-improving, expandable **knowledge-action scaffolding**. 讀者能習得謀**定**而後**動**的「框智力」，並擴展到組織的動態能力@sec-frame-intelligence 與模控治理 @sec-scaling-frame-intelligence 。 
