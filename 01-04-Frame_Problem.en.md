...
This revelation, informed by the classical view of the frame problem, exposed a fundamental implementation flaw at the heart of **[symbolic AI](02-01-symbolic_ai.en.md)**, and spurred the development of workarounds, such as **Circumscription** and **Default Logic**. These methods establish a baseline of constancy within a **specific task or domain**, using rules and assumptions, and thus effectively sidestep the problem.  This, however, also implies the following assumptions:
